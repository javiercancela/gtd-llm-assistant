...
from gtd_assistant.domain.item_kind import ITEM_KIND_WAITING_FOR
...
def gtd_list_for(item_kind: str, language: str, *, tasklists: dict[str, str]) -> str:
    ...
    Spanish captures always go to Personal. English waiting-for items go to
    their dedicated list; everything else (tasks and projects) to Work.
    """
    if language == "es":
