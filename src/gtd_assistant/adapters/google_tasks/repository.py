...
from gtd_assistant.adapters.google_tasks.auth import _build_tasks_service
...
class GoogleTasksRepository:
    """TaskListRepository backed by the Google Tasks API."""

    def list_tasks(self, tasklist: str) -> list[dict[str, Any]]:
        return list_tasks(tasklist=tasklist)

    def list_projects(self, tasklist: str) -> list[dict[str, Any]]:
        return list_projects(tasklist=tasklist)
    ...
    def create_task(
        ...
        *,
        ...
        return create_task(tasklist=tasklist, title=title, notes=notes, url=url)
    ...
    def create_project(
        ...
        *,
        ...
        return create_project(tasklist=tasklist, title=title, notes=notes, url=url)
